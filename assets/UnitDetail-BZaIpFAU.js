import{o as e}from"./rolldown-runtime-C0FnF6B9.js";import{Y as t}from"./chart-vendor-C5Vqh4H_.js";import{s as n}from"./editor-vendor-Ch6zc3nG.js";import{d as r,u as i}from"./router-vendor-C4C_6Mfu.js";import{l as a,n as o,o as s}from"./api-C6QdgyJO.js";import{Bn as c,Et as l,Mr as u,Mt as d,Pr as f,Pt as p,X as m,Zr as h,bn as g,br as _,et as v,g as y,gt as b,li as ee,o as x,pt as te,qn as S,ra as ne,xt as re,zi as C,zn as w,zr as T,zt as E}from"./ui-vendor-BJACYxZ2.js";import{At as ie,Xt as ae,bt as D,in as O,on as oe}from"./index-CCWUv77F.js";import{n as k,r as se,t as ce}from"./AdminToolbar-DlGMLpSD.js";import{t as le}from"./AdminSidebar-Dj_yW167.js";import{t as ue}from"./AdminPageLayout-BYQNl95N.js";import"./ToolLoader-DWnNCUcW.js";import{t as A}from"./MarkdownViewer-iGkysXLG.js";import{t as de}from"./MarkdownEditor-D9UMXfZi.js";import{n as fe,t as pe}from"./NotebookCellsEditor-fEtFYrB8.js";var j=e(t(),1),M=n(),me=e=>{if(!e)return[];if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);return Array.isArray(t)?t:[]}catch{return[]}return[]},he=e=>{if(!e)return``;let t=e;if(typeof e==`string`)try{t=JSON.parse(e)}catch{return e}return Array.isArray(t)?t.map(e=>{let t=`### ${e.type?`[${e.type}]`:`[思考题]`}${e.title?` ${e.title}`:``}\n${e.question||``}`;return e.hint&&(t+=`\n\n> 💡 提示：${e.hint}`),t}).join(`
